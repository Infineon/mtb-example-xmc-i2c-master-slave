...
Prepare your board for the example by interconnecting SDA master to SDA slave and SCL master to SCL slave. You will need a 4.7-kOhm pull-up to VDD for each:

 ![XMC1400 Boot Kit](images/schematics.png)
...
1. Prepare you board as described in the [Hardware Setup](#hardware-setup) section.
...
1. Inside `main()`, the example is initialized:
   ...
   - The Master and slave interface are initialized using personalities.
...
3. Inside I2C slave:
   -  The receive interrupt routine processes the commands sent from I2C master to I2C slave.
...
Document Title: *CE232573* - *XMC MCU: I2C Master and Slave*
